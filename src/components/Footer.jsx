...
const Footer = () => {
  return (
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col relative`}>
      {/* gradient start */}
      <div className="absolute z-[0] w-[60%] h-[60%] -left-[50%] top-0 blue__gradient" />
      {/* gradient end */}

      <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full relative z-[1]`}>
            ...
            <div key={idx} className="flex flex-col ss:my-0 my-4 min-w-[150px]">
              ...
              <ul className="list-none mt-4">
                {footer.links.map((link) => (
                  <li key={link.name} className={`font-poppins font-normal text-[16px] leading-[24px] text-dimWhite hover:text-secondary cursor-pointer ${idx !== footer.links.length - 1 ? 'mb-4' : 'mb-0'}`}>
      ...
      <div className="w-full flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3F3E45] relative z-[1]">
